    ...
    <div class="main">
        <form action="" method="post">
            ...
            <legend>Enter Marks</legend>
                ...
                <input type="text" name="p1" id="" placeholder="Data Structures ">
                <input type="text" name="p2" id="" placeholder="Artificial Intelligence">
                <input type="text" name="p3" id="" placeholder="Database Management">
                <input type="text" name="p4" id="" placeholder="Discrete Mathematics">
                <input type="text" name="p5" id="" placeholder="Addition Language">
...
<?php
    if(isset($_POST['rno'],$_POST['attendance'],$_POST['p1'],$_POST['p2'],$_POST['p3'],$_POST['p4'],$_POST['p5']))
    {
        $rno=$_POST['rno'];
